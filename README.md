...
### 🔬 Technical Skills
- **Programming**: R (Seurat, singleR, nicheNetR, EdgeR, Monocle3, ChIPseeker), Python, Linux/Shell
- **Pipelines & Tools**: Cell Ranger, Pipseq-Pipseeker, CurioSeeker, MACS3, BCFtools
- **Analyses**: scRNA-seq (QC, integration, trajectory, cell-cell communication), bulk RNA-seq (DE, GO), ATAC-seq (peak calling/annotation), spatial transcriptomics, ChIP-seq, Variant Calling, GWAS
...
### 💼 Research Experience
**Graduate Research Assistant** @ University of Minnesota (Jun 2024 – Present)  
- Analyzed scRNA-seq, bulk RNA-seq, ATAC-seq, spatial transcriptomics using Seurat, Monocle3, EdgeR, etc.  
- Built pipelines from FASTQ to counts/peaks; contributed to manuscripts.  

**Graduate Teaching Assistant** (Jan–Apr 2025)  
Mentored students in Linux/bioinformatics for HINF 5440/8440 courses.

---

### 📚 Publications & Preprints (Selected, Total Citations: 77)
- Burrack et al. (2025). *The Journal of Immunology*. (Immunotherapy in pancreatic cancer)
- Khanal et al. (2021). *International Journal of Infectious Diseases*. (MRSA in Nepal, Cited by 41)
- ... (list more; link to Google Scholar for full list)
...
<img width="468" height="379" alt="image" src="https://github.com/user-attachments/assets/546946eb-78c5-4996-9d96-4f8aa7877485" />


---

### 🏆 Awards & Leadership
- Most Collaborative Team – Carnegie Mellon x NVIDIA Hackathon (2026)
- Health Informatics Fellowship (2023–2024)
- Treasurer, Nepal Student Association @ UMN (2024–2025)
- Registered Pharmacist, Nepal Pharmacy Council (2021–Present)
- Member: ISCB, Phi Kappa Phi, ACTS

---

### 📌 Featured Projects
(Check my pinned repos below for pipelines, scripts, and analyses in single-cell omics, transposable elements, etc.)

Feel free to explore, fork, or reach out for collaborations!

Thanks for visiting! ⭐ Star repos if you find them useful.
